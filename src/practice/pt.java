...
public class pt {
        public static void main(String[] args) {
            ...
            int[] extrovertVsIntrovertAnswerBank = new int[5];
            int[] sensingVsIntuitiveAnswerBank = new int[5];
            int[] thinkingVsFeelingAnswerBank = new int[5];
            int[] judgingVsPerceptiveAnswerBank = new int[5];
